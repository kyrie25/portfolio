...
(function () {
  ...
  compile = function () {
    ...
    var b = new TypeScript.TypeScriptCompiler(d);
    ...
    for (f = 0; f < k.length; f++) {
      if (k[f].type == "text/typescript") {
        if (k[f].src) {
          a.push(load(k[f].src));
        } else {
          a.push(k[f].innerHTML);
        }
      }
    }
    if (a.length == 0) {
    ...
    if (
      ...
      sessionStorage.getItem("typescript" + hashCode(a.join("")))
    ) {
      d.source = sessionStorage.getItem("typescript" + hashCode(a.join("")));
    } else {
      b.parser.errorRecovery = true;
      b.setErrorCallback(function (n, e, i, m) {
        console.log(
          "Compilation error: ",
          i,
          "\n Code block: ",
      ...
      b.addUnit(j, "lib.d.ts");
      for (f = 0; f < a.length; f++) {
        b.addUnit(a[f], "");
      }
      b.typeCheck();
      b.emit(false, function l(e) {
        return d;
      });
      if (window.sessionStorage) {
        sessionStorage.setItem("typescript" + hashCode(a.join("")), d.source);
      }
    }
    c = document.createElement("script");
    c.type = "text/javascript";
    c.innerHTML = "//Compiled TypeScript\n\n" + d.source;
    g.appendChild(c);
  };
  compile();
})();
