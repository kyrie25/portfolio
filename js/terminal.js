...
function about() {
  terminal.innerHTML +=
    ...
    "  <div>This is my <span>first ever</span> website\n" +
    "  <div>Basically a portfolio/'About Me'\n" +
    "  <div>It probably won't be updated at the time you're reading this</div>\n" +
    "  <div>Credit to stuff I've used in this page:</div>\n" +
    "  <div>About 70% of the website: Me\n" +
    "  <div><span>Core script/functionality</span>: Generous stranger on GitHub, not sure who they were\n" +
    "  <div><span>Nazrin</span>: rrat\n" +
    ...
    "  <div>Please support the respective owners of the works, they really are awesome <3\n" +
    '  <div style="padding-bottom:10px; clear: both;">';
}
